    ...
    */
    ...
    const handleSignupClick = async () =>
    {
        ...
        catch (err: any)
        {
            ...
            else if (err.message === "email-used") setErrorMessage("Email is already used")
            ...
            <form className="mt-6 space-y-4 max-w-80 w-full" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="flex justify-center mt-4">
                    <select
                        ...
                        className="py-2 px-4 text-center text-sm font-medium text-gray-500 border border-gray-300 rounded-lg focus:ring-4 focus:outline-none dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600">
                ...
                <div className="flex justify-center mt-7">
                    <button
                        ...
                        <span className="no-style">{isLoading ? "Signing Up..." : "Register"}</span>
                    </button>
                </div>
